...
const TermsAndConditions: FunctionComponent<DispatchProps> = ({ onAcceptTermsConditions }) => {
    ...
    <Wrapper>
      <Content>
        ...
        <Label>
          ...
          an entity formed under the laws of: Afghanistan, Cuba, Democratic People's Republic of Korea, Iran,
          Iraq, People’s Republic of China, Russian Federation, Somalia, Sudan, Syria, United Arab Emirates,
        ...
        <br />
        <Label>
          <Checkbox name='disclaimer3' checked={disclaimer3} onToggle={handleDisclaimer3Toggle} />I have read,
          understood, and agree to the full Terms and Conditions:
        </Label>
        <Terms>
          ...
          <p>
            ...
            Estonia under registry No. 14553524 at Ahtri 12, Kesklinna District, 10151 Tallinn, Harju County,
            Estonia. To contact us, please email us at info@slow.trade.
          </p>

          <h3>2. Our Services</h3>
          <p>
            2.1. We provide a graphical user interface on the site https://slow.trade (the “Platform”) to
            facilitate you interacting via a digital wallet, vault or storage mechanism (a “Wallet”) with the
            DutchX decentralized trading protocol for ERC 20 tokens (the “Protocol”).
            <br />
            <br />
            ...
            service, particularly we do not provide any order matching, guaranteed prices, order cancellation
            or similar exchange or trading platform services.
            <br />
            <br />
            ...
            conducted by the Protocol and (2) claiming the Supported Tokens you receive for your trade back to
            that same Wallet.
            <br />
            <br />
            2.4. If you wish to use ETH to trade on the Platform, we offer you an interface to interact with a
            smart contract developed by Gnosis Limited that wraps your ETH making it ERC20 compliant, which
            you will be prompted to before the trade.The Platform does not support the un-wrapping of wrapped
            ETH.
            <br />
            <br />
            ...
            will report any such breach to the relevant law enforcement authorities and we will cooperate with
            those authorities, including, where possible, by disclosing your identity to them. In the event of
            such a breach, your right to use our Platform will cease immediately.
          </p>
        </Terms>
        <br />
        <br />
